...
* used in WoSubversionSourceRepositoryava to display status information. This  implementation
* is passed to
*
...
public class StatusHandler implements ISVNStatusHandler, ISVNEventHandler {
    ...
    public StatusHandler(boolean isRemote, PrintWriter pw) {
        this.pw = pw;
        myIsRemote = isRemote;
    }
    /*
    ...
    public void handleEvent(SVNEvent event, double progress) {
        ...
        if(action == SVNEventAction.STATUS_COMPLETED){
            pw.println("Status against revision:  "+ event.getRevision());
        }
